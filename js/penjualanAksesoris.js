...
const penjualanHandler = {
  ...
  attachTableRowClickHandlers() {
    ...
    $(
      '#tableAksesoris tbody tr, #tableKotak tbody tr, #tableSilver tbody tr, #tableLock tbody tr'
    ).off('click')
  ...
  updateUIForSalesType(type) {
    // Hide all containers
    $(
      '#aksesorisTableContainer, #silverTableContainer, #kotakTableContainer, #manualTableContainer'
    ).hide()
